...
import logoImage from "@assets/Logo H@2x_1758310255552.png";
    ...
    <section className="relative min-h-[100svh] sm:min-h-screen flex items-center justify-center py-8 sm:py-0">
      ...
      <div className="relative z-10 container mx-auto px-3 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          <div className="mb-4 sm:mb-6" data-testid="logo-hero">
            <img 
              src={logoImage} 
              alt="JanazApp Logo" 
              className="h-16 sm:h-18 md:h-20 lg:h-24 w-auto mx-auto drop-shadow-lg brightness-0 invert"
            />
          </div>
